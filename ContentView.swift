                    ...
                    Section("App") {
                        ...
                        HStack {
                            ...
                            Toggle("", isOn: Binding(
                                ...
                                set: { _ in viewModel.toggleTimeFormat() }
                            ))
...
struct CreateCalendarEventView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .background(
                LinearGradient(
                    colors: [PastelTheme.background(isDarkMode: viewModel.isDarkMode), PastelTheme.secondaryBackground(isDarkMode: viewModel.isDarkMode)],
                    startPoint: .top,
                    endPoint: .bottom
                )
                .ignoresSafeArea()
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    HStack {
                        ...
                        Button(action: {
                            ...
                            .padding(.horizontal, 12)
                            .padding(.vertical, 6)
                            .background(PastelTheme.accent.opacity(0.1))
                            .cornerRadius(8)
                            .overlay(
                                RoundedRectangle(cornerRadius: 8)
                                    .stroke(PastelTheme.accent, lineWidth: 0.5)
                            )
                        }
                        .buttonStyle(PlainButtonStyle())
                    }
...
struct PastelToggleStyle: ToggleStyle {
    func makeBody(configuration: Configuration) -> some View {
        HStack {
            ...
            Spacer()
            RoundedRectangle(cornerRadius: 16)
                .fill(configuration.isOn ? PastelTheme.accent : PastelTheme.inputBorder)
