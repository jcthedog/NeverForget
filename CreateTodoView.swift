...
struct CreateTodoView: View {
            ...
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: 20) {
                        ...
                        // Persistent Reminder Section (Todo-specific)
                        VStack(alignment: .leading, spacing: 16) {
    ...
    private func createAlarmSettings() -> TodoAlarmSettings {
        ...
        if isPersistentReminder {
            ...
            settings.persistentAlarmInterval = persistentAlarmInterval
            settings.persistentAlarmDuration = persistentAlarmDuration
